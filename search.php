  ...
  <nav class="navbar fixed-top navbarScroll shadow navbar-expand-lg" style="background-color: #457b9d;">
    ...
    <a href="dashboard" class="navbar-brand text-dark"><img src="assets/logo1.png" height="55"></a>
      ...
      if ($_SESSION['privilege'] == 'admin') {
        ...
        echo '<a class="nav-link" href="add-product"><button class="btn btn-primary shadow-sm rounded-pill">Add Product</button></a><a class="nav-link" href="assets/logout"><button id="logout" class="btn btn-danger shadow-sm rounded-pill" name="logout">Logout</button></a></div></nav>';

        // echo '<table id="product-table" class="product-table"><tr><th>Quantity</th><th>Product Name</th><th>Stock Date</th></tr>';

        echo '<section></section><section class="intro"><div class="mask d-flex align-items-center h-100"><div class="container mt-5 pt-3"><div class="row justify-content-center"><div class="mt-5 col-12"><div class="table-responsive table-striped shadow-lg bg-white" style="border-radius: 1rem;"><div class="card-body text-center" style="border-radius: 1rem;"><table class="table mb-0"><thead><tr><th scope="col">Barcode</th><th scope="col">Quantity</th><th scope="col">Product Name</th><th scope="col">Stock Date</th><th scope="col"></th></tr></thead><tbody>';
